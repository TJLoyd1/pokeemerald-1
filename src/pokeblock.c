...
static void PokeblockAction_Toss(u8 taskId)
{
    ...
    DisplayMessageAndContinueTask(taskId, 10, 10, 13, 1, GetPlayerTextSpeedDelay(), gStringVar7, CreateTossPokeblockYesNoMenu);
}
...
static void TossPokeblockChoice_Yes(u8 taskId)
{
    ...
    DisplayMessageAndContinueTask(taskId, 10, 10, 13, 1, GetPlayerTextSpeedDelay(), gStringVar7, HandleErasePokeblock);
}
