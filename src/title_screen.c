...
const u32 gTest_Mon[] = INCBIN_U32("graphics/pokemon/scraggy/anim_front.4bpp.lz");
const u32 gTestPal_Mon[] = INCBIN_U32("graphics/pokemon/scraggy/normal.gbapal.lz");
const u32 gTest_Mon2[] = INCBIN_U32("graphics/pokemon/bagon/anim_front.4bpp.lz");
const u32 gTestPal_Mon2[] = INCBIN_U32("graphics/pokemon/bagon/normal.gbapal.lz");
const u32 gTest_Mon3[] = INCBIN_U32("graphics/pokemon/abra/anim_front.4bpp.lz");
const u32 gTestPal_Mon3[] = INCBIN_U32("graphics/pokemon/abra/normal.gbapal.lz");
...
static const struct CompressedSpriteSheet sSpriteSheet_Mon3[] =
{
    {gTest_Mon3, 4096, 777},
    {NULL},
};

static const struct CompressedSpritePalette sSpritePal_Mon3[] =
{
    {gTestPal_Mon3, 777},
    {NULL},
};
...
void CB2_InitTitleScreen(void)
{
    ...
    case 1:
		...
		LoadCompressedSpriteSheet(sSpriteSheet_Mon3);
        LoadCompressedSpritePalette(sSpritePal_Mon3);
        gMain.state = 2;
        break;
    case 2:
    {
    ...
    case 4:
        ...
        SetGpuReg(REG_OFFSET_DISPCNT, DISPCNT_MODE_1
                                    ...
                                    | DISPCNT_WIN0_ON
                                    | DISPCNT_OBJWIN_ON);
        m4aSongNumStart(BW_SEQ_BGM_POKEMON_THEME);
        gMain.state = 5;
        break;
    case 5:
...
static void Task_TitleScreenPhase2(u8 taskId)
{
    ...
    else
    {
		...
		CreateSprite(&sMonSpriteTemplate, 195, 110, 0);
		CreateSprite(&sMonSpriteTemplate, 55, 110, 0);
...
static void Task_TitleScreenPhase3(u8 taskId)
{
    ...
    {
        PlayCryInternal(SPECIES_SCRAGGY, 0, 120, 10, 0);
		FadeOutBGM(4);
