    ...
    case HAS_SAVED_GAME:
        if (CalculatePlayerPartyCount() != 0)
        {
            ...
            default:
                ...
                LoadPalette(pal, 256, sizeof(pal));
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, 0x0000FFFF, SPECIES_ZORUA);
...
{
    return CreatePicSprite2(SPECIES_ZORUA, SHINY_ODDS, 0, 1, a, b, 14, -1);
}
...
static void MainMenu_FormatSavegamePlayer(u8 hasParty)
{
    ...
    AddTextPrinterParameterized3(2 + 3 * hasParty, 1, 0, 17, sTextColor_MenuInfo, -1, gStringVar4);
...
static void MainMenu_FormatSavegameTime(u8 hasParty)
{
    ...
    AddTextPrinterParameterized3(2 + 3 * hasParty, 1, 0x6C, 17, sTextColor_MenuInfo, -1, gStringVar4);
...
static void MainMenu_FormatSavegamePokedex(void)
{
    ...
    if (FlagGet(FLAG_SYS_POKEDEX_GET) == TRUE)
    {
        ...
        AddTextPrinterParameterized3(5, 1, 0, 33, sTextColor_MenuInfo, -1, gStringVar4);
...
static void MainMenu_FormatSavegameBadges(void)
{
    ...
    AddTextPrinterParameterized3(5, 1, 0x6C, 33, sTextColor_MenuInfo, -1, gStringVar4);
