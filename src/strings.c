...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("Roy");
const u8 gText_ExpandedPlaceholder_May[] = _("Lucy");
const u8 gText_EggNickname[] = _("Egg");
const u8 gText_Pokemon[] = _("Pokémon");
const u8 gText_ProfBirchMatchCallName[] = _("Prof. May");
...
const u8 gText_DefaultNameTom[] = _("JoJo");
const u8 gText_DefaultNameKenny[] = _("Joseph");
const u8 gText_DefaultNameReid[] = _("Jonathan");
const u8 gText_DefaultNameJude[] = _("Joestar");
const u8 gText_DefaultNameJaxson[] = _("Giorno");
const u8 gText_DefaultNameEaston[] = _("Josuke");
...
const u8 gText_DefaultNameCasey[] = _("Roy");
...
const u8 gText_DefaultNameLianna[] = _("Lucy");
const u8 gText_DefaultNameSara[] = _("Sara");
const u8 gText_DefaultNameMonica[] = _("Monica");
const u8 gText_DefaultNameCamila[] = _("Camilia");
...
const u8 gText_DefaultNameLucy[] = _("Miracle");
...
const u8 gText_SizeComparedTo[] = _("Size Ccompared To ");
...
const u8 gText_MayBrendanMatchCallDesc[] = _("Chilhood Friend");
const u8 gText_NormanMatchCallDesc[] = _("RELIABLE ONE");
const u8 gText_MomMatchCallDesc[] = _("CALM & KIND");
const u8 gText_WallyMatchCallDesc[] = _("Rash Rival");
...
const u8 gText_SideQuestName_10[] = _("Grandma's Errands");
const u8 gText_SideQuestName_11[] = _("A Rare Find");
const u8 gText_SideQuestName_12[] = _("Dirty Deeds Done");
...
const u8 gText_SideQuestName_25[] = _("Bug Expert");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("Complete the Pokédex and show\nProf.Birch");
...
const u8 gText_SideQuestPOC_10[] = _("Grandma");
const u8 gText_SideQuestPOC_11[] = _("Expert Shiny Hunter");
const u8 gText_SideQuestPOC_12[] = _("Otaku Mastubator");
...
const u8 gText_SideQuestPOC_25[] = _("4th Gym Leader");
...
const u8 gText_SideQuestMap_10[] = _("Oldale Town");
const u8 gText_SideQuestMap_11[] = _("Littleroot Town");
const u8 gText_SideQuestMap_12[] = _("Fortree City");
...
const u8 gText_SideQuestMap_25[] = _("Lavaridge Gym");
...
const u8 gText_SideQuestReward_10[] = _("20 Sitrus Berries");
const u8 gText_SideQuestReward_11[] = _("A shiny Pokémon Egg");
const u8 gText_SideQuestReward_12[] = _("Weird Moomoo Milk");
...
const u8 gText_SideQuestReward_25[] = _("3 Mega Stones");
...
const u8 gText_SideQuestReward_30[] = _("Sense of Accomplishment");
