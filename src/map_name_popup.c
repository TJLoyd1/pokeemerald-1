...
static const u8 gRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
	...
	[MAPSEC_CAVE_OF_UNKNOWN] = MAPPOPUP_THEME_STONE,
	[MAPSEC_ANTIQUITY_CITY] = MAPPOPUP_THEME_MARBLE,
	[MAPSEC_BUCHBERRY_WOODS] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_OATWOOD_TOWN] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_VOLCANIC_ROUTE_116] = MAPPOPUP_THEME_STONE2
};
