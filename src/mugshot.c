...
static const u32 sMugshotImg_Roy[] = INCBIN_U32("graphics/mugshots/roy.4bpp.lz");
static const u16 sMugshotPal_Roy[] = INCBIN_U16("graphics/mugshots/roy.gbapal");

static const struct Mugshot sMugshots[] = {
    //ADD YOUR MUGSHOTS HERE
 [MUGSHOT_ROY] = {.x = 19, .y = 6, .width = 64, .height = 64, .image = sMugshotImg_Roy, .palette = sMugshotPal_Roy},
};
