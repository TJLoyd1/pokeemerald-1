const u8 gTrainerClassNames[][20] = {
    [TRAINER_CLASS_PKMN_TRAINER_1] = _("Childhood Friend"),
    [TRAINER_CLASS_PKMN_TRAINER_2] = _("Childhood Friend"),
    [TRAINER_CLASS_HIKER] = _("Hiker"),
    [TRAINER_CLASS_TEAM_AQUA] = _("Obsidian"),
    [TRAINER_CLASS_PKMN_BREEDER] = _("Pokemon Breeder"),
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = _("Obsidian"),
    [TRAINER_CLASS_EXPERT] = _("Expert"),
    [TRAINER_CLASS_AQUA_ADMIN] = _("Obsidian Admin"),
    [TRAINER_CLASS_BLACK_BELT] = _("Black Belt"),
    [TRAINER_CLASS_AQUA_LEADER] = _("Obsidian Leader"),
    ...
    [TRAINER_CLASS_MAGMA_ADMIN] = _("Obsidian Admin"),
    [TRAINER_CLASS_PKMN_TRAINER_3] = _("Foolhardy Rival"),
    [TRAINER_CLASS_BUG_CATCHER] = _("Bug Catcher"),
    [TRAINER_CLASS_PKMN_RANGER] = _("Pokemon Ranger"),
    [TRAINER_CLASS_MAGMA_LEADER] = _("Obsidian Leader"),
    ...
    [TRAINER_CLASS_PYRAMID_KING] = _("Ex-Leader"),
    [TRAINER_CLASS_RS_PROTAG] = _("Professor"),
};
