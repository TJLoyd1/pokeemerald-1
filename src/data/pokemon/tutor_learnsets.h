...
static const u32 sTutorLearnsets[] =
{
	...
	[SPECIES_PURRLOIN_HOEJINNIAN]      = TUTOR_LEARNSET(TUTOR(MOVE_DREAM_EATER)
                                            | TUTOR(MOVE_PSYCH_UP)
                                            | TUTOR(MOVE_SLEEP_TALK)
                                            | TUTOR(MOVE_SNORE)
                                            | TUTOR(MOVE_SUBSTITUTE)
    ...
    [SPECIES_LIEPARD_HOEJINNIAN]       = TUTOR_LEARNSET(TUTOR(MOVE_DREAM_EATER)
                                            | TUTOR(MOVE_PSYCH_UP)
                                            | TUTOR(MOVE_SLEEP_TALK)
                                            | TUTOR(MOVE_SNORE)
                                            | TUTOR(MOVE_SUBSTITUTE)
	...
	[SPECIES_SCRAGGER]       = TUTOR_LEARNSET(TUTOR(MOVE_COUNTER)
                                            | TUTOR(MOVE_FIRE_PUNCH)
                                            | TUTOR(MOVE_ICE_PUNCH)
                                            | TUTOR(MOVE_ROCK_SLIDE)
                                            | TUTOR(MOVE_SLEEP_TALK)
