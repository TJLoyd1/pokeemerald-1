const struct CompressedSpritePalette gMonPaletteTable[] =
{
	...
	SPECIES_PAL(SECTURION, gMonPalette_Secturion),
	...
	SPECIES_PAL(PURRLOIN_HOEJINNIAN, gMonPalette_PurrloinHoejinnian),
    SPECIES_PAL(LIEPARD_HOEJINNIAN, gMonPalette_LiepardHoejinnian),
	...
	SPECIES_PAL(SCRAGGER, gMonPalette_Scragger),
