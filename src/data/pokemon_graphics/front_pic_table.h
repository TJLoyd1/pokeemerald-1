const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
	...
	SPECIES_SPRITE(SECTURION, gMonFrontPic_Secturion),
	...
	SPECIES_SPRITE(PURRLOIN_HOEJINNIAN, gMonFrontPic_PurrloinHoejinnian),
    SPECIES_SPRITE(LIEPARD_HOEJINNIAN, gMonFrontPic_LiepardHoejinnian),
	...
	SPECIES_SPRITE(SCRAGGER, gMonFrontPic_Scragger),
