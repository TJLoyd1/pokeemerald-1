const struct CompressedSpriteSheet gMonBackPicTable[] =
{
	...
	SPECIES_SPRITE(SECTURION, gMonBackPic_Secturion),
	...
	SPECIES_SPRITE(PURRLOIN_HOEJINNIAN, gMonBackPic_PurrloinHoejinnian),
    SPECIES_SPRITE(LIEPARD_HOEJINNIAN, gMonBackPic_LiepardHoejinnian),
	...
	SPECIES_SPRITE(SCRAGGER, gMonBackPic_Scragger),
