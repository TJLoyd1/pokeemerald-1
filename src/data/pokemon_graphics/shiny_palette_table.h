const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
	...
	SPECIES_SHINY_PAL(SECTURION, gMonShinyPalette_Secturion),
	...
	SPECIES_SHINY_PAL(PURRLOIN_HOEJINNIAN, gMonShinyPalette_PurrloinHoejinnian),
    SPECIES_SHINY_PAL(LIEPARD_HOEJINNIAN, gMonShinyPalette_LiepardHoejinnian),
	...
	SPECIES_SHINY_PAL(SCRAGGER, gMonShinyPalette_Scragger),
