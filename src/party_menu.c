...
static const struct ItemBasedForms sItemBasedForms[] = 
{
    ...
    {ITEM_RED_NECTAR,    SPECIES_ORICORIO_POM_POM,  SPECIES_ORICORIO},
    {ITEM_RED_NECTAR,    SPECIES_ORICORIO_PA_U,     SPECIES_ORICORIO},
    {ITEM_RED_NECTAR,    SPECIES_ORICORIO_SENSU,    SPECIES_ORICORIO},
    {ITEM_YELLOW_NECTAR, SPECIES_ORICORIO,          SPECIES_ORICORIO_POM_POM},
    {ITEM_YELLOW_NECTAR, SPECIES_ORICORIO_PA_U,     SPECIES_ORICORIO_POM_POM},
    {ITEM_YELLOW_NECTAR, SPECIES_ORICORIO_SENSU,    SPECIES_ORICORIO_POM_POM},
    {ITEM_PINK_NECTAR,   SPECIES_ORICORIO,          SPECIES_ORICORIO_PA_U},
    {ITEM_PINK_NECTAR,   SPECIES_ORICORIO_POM_POM,  SPECIES_ORICORIO_PA_U},
    {ITEM_PINK_NECTAR,   SPECIES_ORICORIO_SENSU,    SPECIES_ORICORIO_PA_U},
    {ITEM_PURPLE_NECTAR, SPECIES_ORICORIO,          SPECIES_ORICORIO_SENSU},
    {ITEM_PURPLE_NECTAR, SPECIES_ORICORIO_POM_POM,  SPECIES_ORICORIO_SENSU},
    {ITEM_PURPLE_NECTAR, SPECIES_ORICORIO_PA_U,     SPECIES_ORICORIO_SENSU},
};
#endif
...
void ItemUseCB_FormChange(u8 taskId, TaskFunc task)
{
    ...
    if (formeAvailable)
    {
        ...
        CreatePartyMonIconSpriteParameterized(forme, GetMonData(mon, MON_DATA_PERSONALITY), &sPartyMenuBoxes[gPartyMenu.slotId], 0);
        CalculateMonStats(mon);
        GetMonNickname(mon, gStringVar1);
        StringExpandPlaceholders(gStringVar4, ChangedForm);
        DisplayPartyMenuMessage(gStringVar4, FALSE);
        if (GetPocketByItemId(gSpecialVar_ItemId) == POCKET_ITEMS)
            RemoveBagItem(gSpecialVar_ItemId, 1);
        ScheduleBgCopyTilemapToVram(2);
        gTasks[taskId].func = task;
    }
