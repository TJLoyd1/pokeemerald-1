...
static const u8 sText_HitXTimes[] = _("No. de golpes: {B_BUFF1}");
...
static const u8 sText_FoeStoppedWorking[] = _("¡El {B_BUFF1} del enemigo\ndejó de funcionar!");
...
static const u8 sText_PkmnImmobilizedByLove[] = _("¡El amor inmobilizó\na {B_ATK_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnRaisedSpDefALittle[] = _("¡{B_CURRENT_MOVE} de {B_ATK_PREFIX2} aumentó\n un poco la DEF. ESP.!");
static const u8 sText_PkmnRaisedDef[] = _("¡{B_CURRENT_MOVE} de {B_ATK_PREFIX2}\naumentó la DEFENSA.!");
static const u8 sText_PkmnRaisedDefALittle[] = _("¡{B_CURRENT_MOVE} de {B_ATK_PREFIX2} aumentó\n un poco la DEFENSA.!");
static const u8 sText_PkmnCoveredByVeil[] = _("¡Un velo cubre al equipo\nde {B_ATK_PREFIX2}!");
static const u8 sText_PkmnUsedSafeguard[] = _("¡El equipo de {B_DEF_NAME_WITH_PREFIX}\nestá protegido por VELO SAGRADO!");
static const u8 sText_PkmnSafeguardExpired[] = _("¡El VELO SAGRADO del equipo\nde {B_ATK_PREFIX3} desapareció!");
...
static const u8 sText_PkmnLoweredHead[] = _("¡{B_ATK_NAME_WITH_PREFIX} inclinó\nla cabeza!");
...
static const u8 sText_PkmnSqueezedByBind[] = _("¡{B_DEF_NAME_WITH_PREFIX} fue apretado por\nla ATADURA de {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnTrappedInVortex[] = _("¡{B_DEF_NAME_WITH_PREFIX} fue atrapado\nen el vórtice!");
static const u8 sText_PkmnTrappedBySandTomb[] = _("¡{B_DEF_NAME_WITH_PREFIX} fue atrapado\npor TORMENTA ARENA!");
static const u8 sText_PkmnWrappedBy[] = _("¡{B_DEF_NAME_WITH_PREFIX} fue ENVUELTO por\n{B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnClamped[] = _("¡La TENAZA de{B_ATK_NAME_WITH_PREFIX}\nagarró a {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnHurtBy[] = _("¡{B_ATK_NAME_WITH_PREFIX} fue dañado\npor {B_BUFF1}!");
static const u8 sText_PkmnFreedFrom[] = _("¡{B_ATK_NAME_WITH_PREFIX} se liberó\nde {B_BUFF1}!");
static const u8 sText_PkmnCrashed[] = _("¡{B_ATK_NAME_WITH_PREFIX} pasó de largo\ny se estrelló!");
const u8 gText_PkmnShroudedInMist[] = _("¡NEBLINA rodea\na {B_ATK_PREFIX2}!");
static const u8 sText_PkmnProtectedByMist[] = _("¡{B_SCR_ACTIVE_NAME_WITH_PREFIX} fué protegido\npor la NEBLINA!");
const u8 gText_PkmnGettingPumped[] = _("¡{B_ATK_NAME_WITH_PREFIX} se está\npreparando para luchar!");
static const u8 sText_PkmnHitWithRecoil[] = _("¡{B_ATK_NAME_WITH_PREFIX} se hizo daño\na sí mismo!");
...
static const u8 sText_PkmnSappedByLeechSeed[] = _("¡Las DRENADORAS han quitado\nsalud a {B_ATK_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnUproarKeptAwake[] = _("¡Pero siguió despierto por\nel ALBOROTO de {B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnMakingUproar[] = _("¡{B_ATK_NAME_WITH_PREFIX} está causando\nun ALBOROTO!");
...
static const u8 sText_PkmnStockpiled[] = _("¡{B_ATK_NAME_WITH_PREFIX} tiene {B_BUFF1}\nen su RESERVA!");
static const u8 sText_PkmnCantStockpile[] = _("¡{B_ATK_NAME_WITH_PREFIX} ya no puede\nRESERVAR más!");
static const u8 sText_PkmnCantSleepInUproar2[] = _("¡Pero {B_DEF_NAME_WITH_PREFIX} no puede\ndormir por el ALBOROTO!");
static const u8 sText_UproarKeptPkmnAwake[] = _("¡Pero el ALBOROTO mantuvo\na {B_DEF_NAME_WITH_PREFIX} despierto!");
static const u8 sText_PkmnStayedAwakeUsing[] = _("¡{B_DEF_NAME_WITH_PREFIX} siguió despierto\ngracias a {B_DEF_ABILITY}!");
...
static const u8 sText_PkmnFatigueConfusion[] = _("¡{B_ATK_NAME_WITH_PREFIX} quedó\nconfundido por la fatiga!");
static const u8 sText_PkmnPickedUpItem[] = _("¡{B_PLAYER_NAME} recogió\n{B_BUFF1}¥!\p");
static const u8 sText_PkmnUnaffected[] = _("¡No afecta\na {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_SubstituteDamaged[] = _("¡El SUSTITUO recibió daño\ndirigido a {B_DEF_NAME_WITH_PREFIX}!\p");
...
static const u8 sText_123Poof[] = _("{PAUSE 32}1, {PAUSE 15}2, y{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE 0x0038}¡puf!\p");
...
static const u8 sText_GotAwaySafely[] = _("{PLAY_SE 0x0011}¡Escapaste sin problemas!\p");
...
static const u8 sText_WildPkmnFled[] = _("{PLAY_SE 0x0011}¡{B_BUFF1} salvaje ha huido!");
...
static const u8 sText_GotchaPkmnCaught[] = _("¡Ya está!\n¡{B_OPPONENT_MON1_NAME} atrapado!{WAIT_SE}{PLAY_BGM MUS_KACHI22}\p");
static const u8 sText_GotchaPkmnCaught2[] = _("¡Ya está!\n¡{B_OPPONENT_MON1_NAME} atrapado!{WAIT_SE}{PLAY_BGM MUS_KACHI22}{PAUSE 127}");
