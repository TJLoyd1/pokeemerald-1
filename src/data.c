...
const struct SpriteFrameImage gTrainerBackPicTable_Ignes[] =
{
    gTrainerBackPic_Ignes, 0x0800,
    gTrainerBackPic_Ignes + 0x0800, 0x0800,
    gTrainerBackPic_Ignes + 0x1000, 0x0800,
    gTrainerBackPic_Ignes + 0x1800, 0x0800,
};
