...
static const u8 LandmarkName_IslandCave[] = _("CUEVA INSULAR"); // Unused?
static const u8 LandmarkName_DesertRuins[] = _("RUINAS DESIERTO"); // Unused?
static const u8 LandmarkName_ScorchedSlab[] = _("GRUTA SOLAR");
static const u8 LandmarkName_AncientTomb[] = _("TUMBA ANTIGUA"); // Unused?
static const u8 LandmarkName_SealedChamber[] = _("CÁMARA SELLADA"); // Unused?
static const u8 LandmarkName_FossilManiacsHouse[] = _("CASA del FOSILMANÍACO");
static const u8 LandmarkName_HuntersHouse[] = _("CASA DE HUNTER"); // Unused?
static const u8 LandmarkName_MagmaHideout[] = _("ESCONDITE MAGMA"); // Unused?
static const u8 LandmarkName_MirageTower[] = _("TORRE ESPEJISMO"); // Unused?
