...
#define FLAG_DISABLE_TRAINER_ENCOUNTERS  0x20 // Unused Flag
#define FLAG_DISABLE_BALL_THROWS         0x21 // Unused Flag
#define FLAG_DISABLE_COLLISIONS          0x22 // Unused Flag
#define FLAG_DISABLE_BATTLE_BAG_ACCESS   0x23 // Unused Flag
#define FLAG_DISABLE_WILD_ENCOUNTERS     0x24 // Unused Flag
