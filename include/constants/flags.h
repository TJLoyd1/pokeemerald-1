...
#define FLAG_RECEIVED_FIRST_BONUS    0x20 // Unused Flag
...
#define FLAG_LOCK_DEVONBALLS_SELLER          0x100 // GF could have checked for FLAG_MET_DEVON_EMPLOYEE in the script where this flag is used.
