...
#define FLAG_SYS_DETECTOR_MODE                      (SYSTEM_FLAGS + 0x22) // Allows the Player to find hidden 'mons
#define FLAG_SYS_DEXNAV_GET                         (SYSTEM_FLAGS + 0x23) // Makes the Dexnav show in the start menu
